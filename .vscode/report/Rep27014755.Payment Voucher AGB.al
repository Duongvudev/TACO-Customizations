report 27014755 "TACO Payment Voucher AGB"
{
    // version NWV-TACO

    RDLCLayout = './.vscode/rdlc/TACO-Payment Voucher AGB.rdl';
    WordLayout = './.vscode/rdlc/TACO-Payment Voucher AGB.docx';
    DefaultLayout = Word;
    UseRequestPage = true;
    ...
    dataset
    {
        ...
        dataitem(MainData; "NWV Temporary Data Buffer")
        {
            ...
            column(Account_No;
            gCu_CoreEventMgt.FormatValue(Code_1))
            {
            }
